...
"same" elements, with the same multiplicities. "Same" means, here, that the elements in b are the elements
...
def compare(list_1: list, list_2: list) -> bool:
    return sorted(list_2) == sorted([number ** 2 for number in list_1])
